...
if TestNonZeroStart == CurrentTest
    Theta1 = 0.11842*ones(1, size(AlgorithmTimeTable, 2));
    Theta2 = -0.0810238*ones(1, size(AlgorithmTimeTable, 2));
end
...
TransportDelay = 13;
PlantControl = 0;
gamma1 = 0.002; % To set as needed
gamma2 = 0.002; % To set as needed
LastTmp1Change = 0;
LastTmp2Change = 0;
